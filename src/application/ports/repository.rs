...
pub trait EventRepository {
    ...
    fn save(&self, e: SaveEventRequest) -> impl std::future::Future<Output = Result<Event>> + Send;
    fn upsert(&self, entity: Event) -> impl std::future::Future<Output = Result<Event>> + Send;
}
